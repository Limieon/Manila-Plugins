...
public static class MSBuild {
	...
	public static void project(Workspace workspace, Project project, BuildConfig config, Flags flags) {
	...
	public static void workspace(Workspace workspace) {
		SolutionFile.generate(workspace, new ManilaFile(workspace.location, $"{workspace.name}.sln"));
	}
}
